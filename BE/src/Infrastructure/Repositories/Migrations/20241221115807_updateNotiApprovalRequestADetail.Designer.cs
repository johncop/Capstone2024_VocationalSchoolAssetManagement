...
namespace ASM.Database.Migrations
{
    ...
    [Migration("20241221115807_updateNotiApprovalRequestADetail")]
    partial class updateNotiApprovalRequestADetail
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ASM.Core.Entities.RequestDetail", b =>
                {
                    ...
                    b.Property<int>("AssetNewLocationId")
                        .HasColumnType("int");

                    b.Property<string>("AssetOldLocation")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("ASM.Core.Entities.RequestDetail", b =>
                {
                    ...
                    b.HasOne("ASM.Core.Entities.Location", "NewLocation")
                        .WithMany()
